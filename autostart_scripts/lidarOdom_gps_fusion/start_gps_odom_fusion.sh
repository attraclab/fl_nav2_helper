...
export DISPLAY=:0.0
export LOGFILE=/home/$USER/$rosws/src/$rospackage/autostart_scripts/gps_odom_fusion.log
...
do
		...
		ros2 launch fl_nav2_helper  gps_robot_localization.launch.py >> $LOGFILE
