...
export DISPLAY=:0.0
export LOGFILE=/home/$USER/$rosws/src/$rospackage/autostart_scripts/fence_handler.log
...
do
		...
		echo "Starting fence_handler" >> $LOGFILE
		
		ros2 launch fl_nav2_helper  fence_handler.launch.py >> $LOGFILE
